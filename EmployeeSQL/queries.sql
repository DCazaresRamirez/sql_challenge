...
/* 2. first name, last name, and hire date for 
	the employees who were hired in 1986. */
SELECT first_name, last_name, hire_date
FROM Employees
WHERE EXTRACT(YEAR FROM hire_date) = 1986;

/* 3. manager of each department along with 
...
/* 5. List first name, last name, and sex of 
	each employee whose first name is Hercules 
...
SELECT 
    ...
    e.first_name
FROM Employees e
JOIN DeptEmp de ON e.emp_no = de.emp_no
JOIN Departments d ON de.dept_no = d.dept_no
